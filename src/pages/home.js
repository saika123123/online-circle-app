...
export default function Home() {
    ...
    useEffect(() => {
        ...
        if (!token) {
            ...
            try {
                const decoded = jwt.decode(token); // jwt.decodeを使用してトークンをデコード
    ...
    const circleButtonStyle = createButtonStyle('#3498db'); // 青色
    const gatheringButtonStyle = createButtonStyle('#2ecc71'); // 緑色
    ...
    return (
        <div style={containerStyle}>
            <div style={cardStyle}>
                <h1 style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '1rem', textAlign: 'center' }}>オンラインサークルサービス</h1>
                {currentTime && (
                ...
                <div style={flexContainerStyle}>
                    <div style={sectionStyle}>
                        <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', marginBottom: '1rem' }}>サークル関連</h2>
                        <Link href="/online-circle/join-circle" style={circleButtonStyle}>
                            <svg style={iconStyle} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path d="M8 9a3 3 0 100-6 3 3 0 000 6zM8 11a6 6 0 016 6H2a6 6 0 016-6zM16 7a1 1 0 10-2 0v1h-1a1 1 0 100 2h1v1a1 1 0 102 0v-1h1a1 1 0 100-2h-1V7z" />
                            </svg>
                            サークルに入る
                        </Link>
                        <Link href="/online-circle/check-circles" style={circleButtonStyle}>
                            <svg style={iconStyle} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <Link href="/online-circle/create-circle" style={circleButtonStyle}>
                            <svg style={iconStyle} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clipRule="evenodd" />
                            </svg>
                            サークルを作成
                        </Link>
	                <Link href="/online-circle/circle-activities" style={circleButtonStyle}>
        <svg style={iconStyle} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        ...
        活動記録を見る
                    ...
                    <div style={sectionStyle}>
                        <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', marginBottom: '1rem' }}>寄合(ビデオ通話)関連</h2>
                        <Link href="/online-circle/create-gathering" style={gatheringButtonStyle}>
                            <svg style={iconStyle} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                            </svg>
                            寄合を作成
                        </Link>
                        <Link href="/online-circle/check-invitations" style={gatheringButtonStyle}>
                            <svg style={iconStyle} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <Link href="/online-circle/gathering-list" style={gatheringButtonStyle}>
                            <svg style={iconStyle} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z" />
                            </svg>
                            寄合一覧
                        </Link>
	                <Link href="/online-circle/gathering-history" style={gatheringButtonStyle}>
                            <svg style={iconStyle} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <button onClick={handleLogout} style={logoutButtonStyle}>
                        <svg style={logoutIconStyle} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
